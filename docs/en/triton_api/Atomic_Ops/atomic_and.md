...
Introduction: Atomic logical AND operation, performs a logical AND at the specified memory location.
Prototype:
...
| -------------- | ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `pointer`      | `triton.PointerDType` | The memory location to operate on. The result of computing *pointer & val is written back to this memory location.                        |
| `val`          | `pointer.dtype.element_ty` | The value to use for the atomic AND operation (right operand).                                                                         |
...
The following example demonstrates an atomic AND computation:
