...
Introduction: Atomic addition operation, performs atomic addition at the specified memory location.
Prototype:
...
| `val`          | `pointer.dtype.element_ty` | The value to be added in the atomic operation (right operand).          |
