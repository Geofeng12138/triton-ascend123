...
Introduction: Atomic maximum operation, performs an atomic max operation at the specified memory location.
Prototype:
...
The following example implements an atomic maximum operation:
