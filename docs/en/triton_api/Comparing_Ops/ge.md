...
| :---: | :---: | :---: |
| `input` | `tensor` | Tensor data, left operand, represents the primary data to be compared |
...
The following example implements the greater-than-or-equal operation on 3D tensors `x0` and `x1`:
