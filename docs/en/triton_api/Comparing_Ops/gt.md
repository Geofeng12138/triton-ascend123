...
The following example implements the greater-than operation on 3D tensors `x0` and `x1`:
...
> Community capabilities are missing but can be developed and supported
