...
## Indexing & Element Operations

|api|Description|
|--|--|
|[flip](./Indexing_Ops/flip.md) |Flips the tensor x along the dimension dim |
|[where](./Indexing_Ops/where.md) |Returns a tensor of elements selected from either x or y based on condition |
...
| [program_id](./Programming_Model/program_id.md) | Returns the id of the current program instance along a specified axis |
| [num_programs](./Programming_Model/num_programs.md) | Returns the number of current program instances along a specified axis |
...
|[randint](./Random_Number_Generation/randint.md) |Given a seed scalar and an offset block, returns 1 random block of type int32 |
|[rand](./Random_Number_Generation/rand.md)   |Given a seed scalar and an offset block, returns 1 random block of type float32 in U(0,1) |
|[randn](./Random_Number_Generation/randn.md)   |Given a seed scalar and an offset block, returns 1 random block of type float32 in N(0,1) |
...
|api|Description|
|--|--|
|[argmax](./Reduction_Ops/argmax.md) |Returns the index of the maximum value among all elements of the input tensor along the specified axis |
|[argmin](./Reduction_Ops/argmin.md) |Returns the index of the minimum value among all elements of the input tensor along the specified axis |
|[max](./Reduction_Ops/max.md) |Returns the maximum value among all elements of the input tensor along the specified axis |
|[min](./Reduction_Ops/min.md) |Returns the minimum value among all elements of the input tensor along the specified axis |
|[reduce](./Reduction_Ops/reduce.md) |Applies combine_fn to all elements of the input tensor along the specified axis |
|[sum](./Reduction_Ops/sum.md) |Returns the sum of all elements of the input tensor along the specified axis |
|[xor_sum](./Reduction_Ops/xor_sum.md) |Returns the XOR sum of all elements of the input tensor along the specified axis |
...
|api|Description|
|--|--|
|[associative_scan](./Scan_Sort_Ops/associative_scan.md) |Applies combine_fn to each element of the input tensor and a carried value along the specified axis, updating the carried value |
|[cumprod](./Scan_Sort_Ops/cumprod.md) |Returns the cumulative product of all elements of the input tensor along the specified axis |
|[cumsum](./Scan_Sort_Ops/cumsum.md)  |Returns the cumulative sum of all elements of the input tensor along the specified axis |
|[histogram](./Scan_Sort_Ops/histogram.md) |Computes a histogram with num_bins bins based on the input tensor, each bin having a width of 1 and starting at 0 |
|[sort](./Scan_Sort_Ops/sort.md) |Sorts a tensor along a specified dimension |
...
|api|Description|
|--|--|
|[broadcast](./Shape_Manipulation_Ops/broadcast.md) | Attempts to broadcast two given blocks to a common compatible shape |
...
|[join](./Shape_Manipulation_Ops/join.md) | Concatenates given tensors in a new minor dimension |
...
|[reshape](./Shape_Manipulation_Ops/reshape.md) | Returns a tensor with the same number of elements as the input but with a provided shape|
|[split](./Shape_Manipulation_Ops/split.md) | Splits a tensor into two parts along its last dimension, which must be of size 2 |
