...
Introduction: Integer division, returns the division result rounded towards zero, corresponding to the arithmetic operator '//'. There is no `tl.floordiv` method.
...
The following example demonstrates integer division on input tensors `in_ptr0, in_ptr1`:
