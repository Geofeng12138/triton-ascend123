...
| -------------- | ------------------ | ------------------------------------------------------------------ |
| `src`          | `tensor`           | The source tensor for which multi-buffering is to be set           |
...
The following example demonstrates how to set multi-buffering for the tensor `tmp0` within a kernel, combined with other compilation hints:
