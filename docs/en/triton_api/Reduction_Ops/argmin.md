...
| `tie_break_left` | `bool` | If multiple elements have the same minimum value, return the index of the leftmost minimum |
...
Compared to GPU, the Ascend A3 lacks support for uint16, uint32, uint64, and fp64.
