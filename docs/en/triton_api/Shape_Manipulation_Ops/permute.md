...
Rearranges the dimensions of a tensor according to the `dims` parameter. It does not change the tensor's data, only the order of its dimensions. Supports arbitrary dimension rearrangement.
...
- Rearranges tensor dimensions according to the `dims` parameter
