...
Reorders the dimensions of a tensor according to the `dims` parameter. The data of the tensor remains unchanged; only the order of dimensions is altered. Supports reordering of any number of dimensions.
...
- Supports reordering of any number of dimensions
...
- **Memory Layout:** Transposition achieved by modifying stride information; no data copy occurs
