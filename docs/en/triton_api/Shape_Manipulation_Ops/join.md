...
Concatenates two input tensors of the same shape along a new innermost dimension. The output tensor has one more dimension than the input tensors, with a size of 2, while other dimensions remain unchanged.
