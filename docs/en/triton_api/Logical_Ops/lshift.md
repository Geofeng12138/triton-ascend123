...
Introduction: Performs a left bitwise shift on a tensor according to the given value.
...
The following example performs a left shift operation on three-dimensional tensors `x0` and `x1`:
