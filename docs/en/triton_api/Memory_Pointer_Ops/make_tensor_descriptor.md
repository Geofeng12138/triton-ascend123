...
Prototype (Triton version 3.4.0):
...
| `strides`    | `List[tensor]`      | List of strides for each dimension of the tensor, with constraints: - Preceding dimensions must be multiples of 16 bytes - The last dimension must be contiguous |
...
> Community capabilities are missing and cannot be implemented.
