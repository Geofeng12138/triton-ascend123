...
If printing a **non-constant** result, it will print a value of the form `data_type[data_shape(empty for scalars)]`. For example, if the data type pointed to by `x_ptr` is `int32`, it will print `val:int32[constexpr[4]]`:
