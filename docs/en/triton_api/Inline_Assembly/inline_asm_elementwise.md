...
| `constraints` | `str` | Required | LLVM-format assembly constraint string |
...
3. Currently, only one-dimensional tensors are supported as input; high-dimensional tensors must be flattened for computation.