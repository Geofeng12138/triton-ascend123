...
Description: Performs a gather operation on the `src` tensor along the `axis` dimension using `index`. The meaning of the gather operation is illustrated in the figure below:
![image](./gather.png)
