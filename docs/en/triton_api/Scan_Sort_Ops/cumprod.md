...
The `cumprod` function computes the cumulative product (prefix product) along the specified axis. For example, for the input `[a, b, c, d]`, the cumulative product result is `[a, a*b, a*b*c, a*b*c*d]`.
