...
_VLLM_MAIN_VERIFIED_COMMIT_PATH = _REPO_ROOT / ".github" / "triton-master-verified.commit"
_VLLM_RELEASE_TAG_PATH = _REPO_ROOT / ".github" / "triton-release-tag.commit"
...
linkcheck_ignore = [
    ...
    r"https?://192\.0\.0\.1(:\d+)?($|/.*)",
    r"https?://<[^>]+>.*",
    r"https://github\.com/triton-lang/triton-ascend/issues/new/choose",
    r"https://github\.com/[^/?#]+/?$",
    r"https?://.*\$%7B.*%7D.*",
]
